...
internal func transform<T: Collection>(_ a: T,
                                       _ b: T,
                                       _ cmpr: (inout [T.Iterator.Element],
                                                T,
                                                T,
                                                T.Iterator.Element) -> Void) -> [T.Iterator.Element] where T.Iterator.Element: Equatable {
...
internal func shuffle<T: MutableCollection, U: Collection>(_ source: inout T, _ salt: U) where T.Index == Int,
    T.Iterator.Element: UnsignedInteger,
...
internal func shuffle<T: MutableCollection, U: Collection>(_ source: inout T,
                                                           _ salt: U,
                                                           _ saltRange: Range<Int>) where T.Index == Int,
    T.Iterator.Element: UnsignedInteger,
    T.Iterator.Element == U.Iterator.Element,
    T.Index == U.Index {
